...
class Follow(models.Model):
    who = models.ForeignKey(CustomUser, related_name='who', on_delete=models.CASCADE)
    whom = models.ForeignKey(CustomUser, related_name='whom', on_delete=models.CASCADE)
